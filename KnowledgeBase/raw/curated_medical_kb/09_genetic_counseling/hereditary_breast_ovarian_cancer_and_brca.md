# Hereditary Breast/Ovarian Cancer and BRCA Education

## Purpose

This document supports patient-safe education about hereditary breast and ovarian cancer. It does not determine whether a patient has a hereditary syndrome or recommend testing, surgery, medication, or family testing.

## BRCA1 and BRCA2 basics

BRCA1 and BRCA2 are genes involved in DNA repair. Harmful inherited changes, also called pathogenic variants, can increase the risk of several cancers, especially breast and ovarian cancer. A BRCA result must be interpreted with the patient's personal history, family history, ancestry when relevant, and the exact laboratory classification.

BRCA testing is usually performed from a blood or saliva sample for inherited or germline testing. Tumor genetic testing is different: it looks for changes in cancer cells and may or may not reflect an inherited variant.
...
- Mayo Clinic BRCA Gene Test: https://www.mayoclinic.org/tests-procedures/brca-gene-test/about/pac-20384815
- NCI BRCA Gene Changes Fact Sheet: https://www.cancer.gov/about-cancer/causes-prevention/genetics/brca-fact-sheet
- NCI Breast Cancer Risk Factors: https://www.cancer.gov/types/breast/causes-risk-factors

...
BENCHMARK_SPEC_PATH = ROOT_DIR / "config" / "benchmark_registry_specs.json"


def _load_benchmark_specs() -> list[dict[str, Any]]:
    """Load the declarative benchmark catalog without growing this service."""
    return json.loads(BENCHMARK_SPEC_PATH.read_text(encoding="utf-8"))


BENCHMARK_SPECS: list[dict[str, Any]] = _load_benchmark_specs()

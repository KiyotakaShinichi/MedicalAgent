...
BENCHMARK_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "metrics": {
            "status": ["status"],
            "patient_n": ["patient_explanation_n"],
            "bootstrap_n": ["bootstrap_n"],
            "model_retraining_stability": ["model_retraining_stability_evaluated"],
            "clinical_validation": ["clinical_validation"],
        },
    },
    {
        "id": "xai_retraining_stability",
        "title": "Synthetic XAI retraining stability",
        "path": "Data/evals/models/latest_xai_retraining_stability.json",
        "tier": "supporting",
        "metrics": {
            "status": ["status"],
            "seed_count": ["seed_count"],
            "global_top_k_jaccard_p05": ["metrics", "global_top_k_jaccard_p05"],
    ...
    },
    {
        ...
        "title": "Bounded agent execution policy",
        "path": "Data/evals/agentic_tool_use/latest_agent_execution_policy_eval.json",
        "tier": "supporting",
        "metrics": {
            "status": ["status"],
            "pass_rate": ["pass_rate"],
            "live_patient_write": ["live_patient_write_performed"],
            "clinical_authority": ["clinical_authority_allowed"],
        },
    },
    {
        "id": "rag_degradation_resilience",
        "title": "Local RAG degradation resilience",
        "path": "Data/evals/rag/latest_rag_degradation_resilience.json",
        "tier": "supporting",
        "metrics": {
            "status": ["status"],
            "pass_rate": ["pass_rate"],
            "managed_network_request": ["managed_network_request_performed"],
            "production_recovery_proven": ["production_outage_recovery_proven"],
        },
    },
    {
    ...
    {
        "id": "automation_channel_drill",
        "title": "Signed localhost automation channel drill",
        "path": "Data/evals/ops/latest_automation_channel_drill.json",
        "tier": "supporting",
        "metrics": {
            "pass_rate": ["pass_rate"],
            "attempt_count": ["attempt_count"],
            "external_delivery": ["external_delivery_performed"],
            "human_acknowledgement": ["delivery_receipt_is_human_acknowledgement"],
        },
    },
    {
        "id": "synthetic_automation_staging",
        "title": "Synthetic n8n and MailHog staging readiness",
        "path": "Data/evals/ops/latest_synthetic_automation_staging_readiness.json",
        "tier": "supporting",
        "metrics": {
            "status": ["status"],
            "runtime_completed": ["runtime_completed"],
            "external_delivery": ["external_delivery_completed"],
            "human_acknowledgement": ["human_acknowledgement_completed"],
        },
    },
    {
        "id": "software_supply_chain",
        "title": "Lock-derived SBOM and secret-scan evidence",
        "path": "Data/evals/ops/latest_software_supply_chain_evidence.json",
        "tier": "supporting",
        "metrics": {
            "status": ["status"],
            "component_count": ["sbom", "component_count"],
            "secret_findings": ["secret_scan", "finding_count"],
            "container_scan_executed": ["container_scan", "executed"],
        },
    },
    {
    ...
    {
        "id": "constraint_aware_improvement_program",
        "title": "Constraint-aware cross-domain improvement program",
        "path": "Data/evals/governance/latest_constraint_aware_improvement_program.json",
        "tier": "supporting",
        "metrics": {
            "status": ["status"],

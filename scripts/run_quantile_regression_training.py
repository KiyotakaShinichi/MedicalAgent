"""Train the p10/p50/p90 quantile regression heads + write metadata."""
import json
import sys
...
if __name__ == "__main__":
    metadata = train_quantile_regression_heads()
    ...
    print(json.dumps({
        ...
        "monotonic_rate_p10_p50_p90": metadata.get("monotonic_rate_p10_p50_p90"),

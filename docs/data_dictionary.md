...
| BreastDCEDL/I-SPY1 | `pcr_label` / `outcome_label_value` where `outcome_label_name = pCR` | Pathologic complete response context. | pCR is a pathology endpoint, not the NLCare synthetic response label. |
...
| BreastDCEDL / I-SPY | DCE-MRI, pCR, HR/HER2, age | MRI pCR benchmark; pCR is not NLCare treatment-success |

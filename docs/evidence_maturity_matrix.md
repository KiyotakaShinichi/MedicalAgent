...
| SWE/release discipline | 2 (internal_self_test) | Integrated ship manifest status=failed with repeatable tests and release gates. | Evidence is owner-run; architecture has large modules and no independent clean-clone reproduction. |

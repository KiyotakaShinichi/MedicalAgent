...
| Temporal stress test | Reported (unavailable without longitudinal splits) | Synthetic |
| Noise robustness | Reported (unavailable without production inference) | Synthetic |
...
|-------|---------------|
| Retrieval | Hybrid: BM25 lexical + TF-IDF vector index |

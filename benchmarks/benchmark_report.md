...
Generated at: 2026-07-30T05:55:39.386418+00:00
...
| PoC service health snapshot | supporting | needs_attention | fresh | status=needs_attention; stale_artifact_count=122; failed_benchmark_count=0 | `Data/evals/ops/latest_service_health_snapshot.json` |
...
| Route latency budget | supporting | acceptable | fresh | status=acceptable; route_count=7; needs_attention_count=0; highest_observed_p95_ms=264.220 | `Data/evals/ops/latest_route_latency_budget.json` |
...
| Fixed-baseline local retrieval runtime-cache evidence | supporting | improved_local_regression | fresh | status=improved_local_regression; retrieval_p95_delta_ms=-1722.070; sample_contract_met=True; production_ready=False | `Data/evals/ops/latest_retrieval_runtime_cache_eval.json` |
...
| Synthetic model perturbation and retraining stress | supporting | needs_attention | fresh | status=needs_attention; stress_failures=[{'scenario': 'modality_dropout', 'metric_deltas': {'classification_auroc': -0.051969, 'classification_brier': 0.02081, 'regression_mae': 4.368769}}, {'scenario': 'train_default_test_realism_v2', 'metric_deltas': {'classification_auroc': -0.141673, 'classification_brier': 0.081659, 'regression_mae': 9.851866}}]; promotion_decision=HOLD_SYNTHETIC_ONLY; clinical_validation=False | `Data/evals/models/latest_synthetic_model_perturbation_retrain_eval.json` |

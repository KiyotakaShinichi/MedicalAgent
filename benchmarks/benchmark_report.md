...
Generated at: 2026-08-02T13:44:26.868473+00:00
...
| KB source governance (tier + allowed_use + staleness) | supporting | strong | fresh | status=strong; source_count=46; chunk_count=240; governance_issue_count=[] | `Data/evals/rag/latest_kb_source_governance.json` |
...
| Route latency budget | supporting | acceptable | fresh | status=acceptable; route_count=7; needs_attention_count=0; highest_observed_p95_ms=165.440 | `Data/evals/ops/latest_route_latency_budget.json` |
...
| Fixed-baseline local retrieval runtime-cache evidence | supporting | improved_local_regression | fresh | status=improved_local_regression; retrieval_p95_delta_ms=-1759.080; sample_contract_met=True; production_ready=False | `Data/evals/ops/latest_retrieval_runtime_cache_eval.json` |

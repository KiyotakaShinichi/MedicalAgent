...
| External stress-test readiness | supporting | strong | fresh | status=strong; dataset_count=4; datasets_with_local_rows=1; expected_abstained_rows=159; promotion_allowed=False | `Data/evals/models/latest_external_stress_test_readiness.json` |

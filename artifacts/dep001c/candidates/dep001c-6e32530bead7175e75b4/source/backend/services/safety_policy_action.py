...
def select_policy_action(
    *,
    ...
    urgent_family_vote = (
        ...
        and family_confidence >= family_threshold
    ...
    if urgent >= urgent_independent_threshold or urgent_family_vote:
        return _decision(
            ...
            "independent_urgent_head_or_supported_urgent_family",
            family,
            unsafe,
            urgent,
            family_confidence,
    ...
    # A coarse family prediction is not sufficient evidence for refusal by
    # itself. The independent unsafe head must agree; otherwise ordinary
    # education containing treatment vocabulary is needlessly blocked.
    if actionable_vote and unsafe_vote:
        action = (
            PolicyAction.SAFE_REDIRECT
        ...
        return _decision(
            action,
            "actionable_personalized_intent",
            family,
            unsafe,
            urgent,
            family_confidence,

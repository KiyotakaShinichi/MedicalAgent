...
def test_schema_has_filterable_governance_fields_and_vector_profile():
    report = build_azure_search_index_readiness(root_dir=ROOT_DIR)
...
def test_apply_uses_idempotent_put_and_redacts_response():
